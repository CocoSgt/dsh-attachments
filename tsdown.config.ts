...
export default defineConfig([
  ...
  },
  {
    ...
    outputOptions: {
      ...
      banner: 'window.__ModuleLoader__.load({ id: "dsh-file-upload", factory: (require) => {',
